...
var helloMessage = sayHello("Jennifer");
...
console.log("number: " + random + " is " + isTwo(random));
...
console.log(calculateTip(.10, 35));
console.log(calculateTip(.15, 35));
// /**
//  * TODO:
...
// //var parseFloat(prompt("You want to tip 20%, right?"));
//
// //alert "you should tip: " + calculateTip(amountToTip, bill).toFixed(2)):
//
// /**
//  * TODO:
